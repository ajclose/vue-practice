      ...
      <form @submit.prevent="onSubmit">
        <div class="input" :class="{invalid: $v.email.$error}">
          ...
          <input
                  ...
                  <p v-if="!$v.email.required">Field can't be empty</p>
        </div>
          ...
          <div class="hobby-list">
            <div
              ...
              <input
                      type="text"
                      :id="hobbyInput.id"
                      @blur="$v.hobbyInputs.$each[index].$touch()"
                      v-model="hobbyInput.value">
              <button @click="onDeleteHobby(hobbyInput.id)" type="button">X</button>
            </div>
            <p v-if="!$v.hobbyInputs.required">Please add hobbies</p>
            <p v-if="!$v.hobbyInputs.minLength">You must have at least {{ $v.hobbyInputs.$params.minLength.min }} hobbies</p>
          </div>
        </div>
